''' Nesse arquivo contém as funções que realizam as pesquisas das tarefas,
    o sistema ainda não contém permissionamento de usuário, logo, todos podem acessar todas as tarefas existentes.
